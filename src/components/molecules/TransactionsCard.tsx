  ...
  return <Card style={{ height: "100%", maxHeight: "100%", width: "100%" }}>
    ...
    <CardContent style={{ height: "100%", paddingTop: "0px" }}>
      <div style={{ maxHeight: "100%", overflowY: "auto" }}>
        <List >
          {[
            { icon: ArrowCircleUpOutlinedIcon, opponent: "xxxx-xxxx-xxxx-xxxx", type: "Transfer", date: "2022/01/01 01:01:00", amount: "10", mosaic: MAIN_NET_CURRENCY_NAME, hash: "xxxxxxxxxxxxxxxxxxxxxxxxxxxx" },
            { icon: ArrowCircleDownOutlinedIcon, opponent: "xxxx-xxxx-xxxx-xxxx", type: "Transfer", date: "2022/01/01 01:01:00", amount: "10", mosaic: MAIN_NET_CURRENCY_NAME, hash: "xxxxxxxxxxxxxxxxxxxxxxxxxxxx" },
            { icon: ArrowCircleUpOutlinedIcon, opponent: "xxxx-xxxx-xxxx-xxxx", type: "Transfer", date: "2022/01/01 01:01:00", amount: "10", mosaic: MAIN_NET_CURRENCY_NAME, hash: "xxxxxxxxxxxxxxxxxxxxxxxxxxxx" },
            { icon: ArrowCircleDownOutlinedIcon, opponent: "xxxx-xxxx-xxxx-xxxx", type: "Transfer", date: "2022/01/01 01:01:00", amount: "10", mosaic: MAIN_NET_CURRENCY_NAME, hash: "xxxxxxxxxxxxxxxxxxxxxxxxxxxx" },
            { icon: ArrowCircleUpOutlinedIcon, opponent: "xxxx-xxxx-xxxx-xxxx", type: "Transfer", date: "2022/01/01 01:01:00", amount: "10", mosaic: MAIN_NET_CURRENCY_NAME, hash: "xxxxxxxxxxxxxxxxxxxxxxxxxxxx" },
            { icon: ArrowCircleDownOutlinedIcon, opponent: "xxxx-xxxx-xxxx-xxxx", type: "Transfer", date: "2022/01/01 01:01:00", amount: "10", mosaic: MAIN_NET_CURRENCY_NAME, hash: "xxxxxxxxxxxxxxxxxxxxxxxxxxxx" },
